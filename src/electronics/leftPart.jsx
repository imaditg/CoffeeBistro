        ...
        <>
            <div className="left-outer">
                <ul className="left-top">
                    <li><h3><a href="/#">electronics</a></h3></li>
                    <li><a href="/#"><span>mobiles</span><button type="button" onClick={() => { setBtn1(!btn1) }} className={btn1 ? 'plus' : 'minus'}></button></a>
                    ...
                    <li><a href="/#"><span>cameras</span><button type="button" onClick={() => { setBtn2(!btn2) }} className={btn2 ? 'plus' : 'minus'}></button></a>
